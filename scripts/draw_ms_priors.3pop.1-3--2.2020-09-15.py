	...
	with open("parameters.txt", "w") as PARAMETERS_OUT:
		...
		for i in range(n_iterations) : # argfile specifies how many sets!
			...
			if prior_args["N_priors_shape"] == "flat":
				...
				Nanc13 = numpy.random.uniform( prior_args["Nanc13"][0], prior_args["Nanc13"][1] )
			...
			T_merge_1_into_3 = numpy.random.uniform( prior_args["T_merge_1_into_3"][0],  prior_args["T_merge_1_into_3"][1])
...
#			print (numpy.mean(relative_Ns))
			...
			for idx in range( nloci ):
				loc_Ns = [x*relative_Ns[idx] for x in [N1_recent, N2_recent, N3_recent, N1_ancient, N2_ancient, N3_ancient, Nanc13, Nanc123]]
...
#			print (hetero_Ns)
			...
			N1_recent, N2_recent, N3_recent, N1_ancient, N2_ancient, N3_ancient, Nanc13, Nanc123, T_N1_ancient, T_N2_ancient , T_N3_ancient, T_merge_1_into_3,	T_merge_anc13_into_2, T_m12_start,T_m12_stop,T_m13_start,T_m13_stop,T_m21_start,T_m21_stop,T_m23_start,T_m23_stop,T_m31_start,T_m31_stop,T_m32_start, T_m32_stop, 
			...
			for idx, locus in enumerate(loci_properties):
				...
				[locus_theta, locus_rho, locus_nsites, nsam_1, nsam_2, nsam_3, total_nsam_per_locus], [m12, m13, m21, m23, m31, m32], [N1_recent, N2_recent, N3_recent, N1_ancient, N2_ancient, N3_ancient, Nanc13, Nanc123] = loci_properties[idx], migrates[idx], hetero_Ns[idx]	
