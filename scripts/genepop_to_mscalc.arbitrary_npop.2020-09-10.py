...
#	print(contig_len_dict)
	...
	print("WARNING: " + str( len(set(bad_loci))) + " contigs were dropped because they had no samples left after cleaning for incomplete missingness along the contig")
#	print("HERE WE ARE")
	
	# we get rid of the bad contigs and sort the remainder
	loci_ordered = sorted( list( set(contig_len_dict.keys()) - set(bad_loci) ) )
	
#	print ("again", loci_ordered)
