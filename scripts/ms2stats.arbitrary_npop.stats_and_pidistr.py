...
def get_pop_pairwise_stats (pair, all_loci_freqs, locilengths, piA_list, piB_list):
	...
	try: # excepting the unlikely case where there are no Fst values as they end up undefined (no variable sites in any of the contigs ! )
		Fst_perc05, Fst_perc25, Fst_perc50, Fst_perc75, Fst_perc95 = np.percentile(Fst_list, [5, 25, 50, 75, 95])
	except IndexError:
		Fst_perc05, Fst_perc25, Fst_perc50, Fst_perc75, Fst_perc95 = ["na","na","na","na","na"]
...
#						stats = ["na"]*len(ABCstats_header)
	...
	with open("pi_distr_mean_1.txt","w") as O:
