...
# the pipeline itself
python $toolbase/draw_ms_priors.3pop.1-3--2.2020-09-15.py -bpfile $bpfile -argfile $argfile -relative_N $Ndist | $toolbase/msnsam/msnsam tbs $msnsam_arg2 $msnsam_model_cmd | python $toolbase/ms2stats.arbitrary_npop.counter.py | python -W ignore $toolbase/ms2stats.arbitrary_npop.stats.py
