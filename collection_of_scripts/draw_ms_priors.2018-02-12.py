...
def draw_and_pipe_priors_ghost_off (n_iterations, loci_properties, prior_args):
	
	"""
	The ghost can be removed from the scenario by setting Nghost = 0 (ghost has no individuals), Nanc12 = Nanc, Tsplit_anc-ghost = T_split12 
	(1 and 2 merge straight into Nanc instead of first spending time in Nanc12),  and m1ghost_scale = m2ghost_scale = 0 ;  
	m1ghost_beta1 = m2ghost_beta1 = 1 ; m1ghost_beta2 = m2ghost_beta2 = 0 (beta distrib. does actually not matter because it is multiplied by scale = 0)
	"""
...
if ghostswitch == True:
	...
	draw_and_pipe_priors_ghost_off (n_iterations, loci_properties, prior_args)
