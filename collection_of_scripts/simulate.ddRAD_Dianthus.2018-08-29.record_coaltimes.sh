...
# the pipeline itself
python $toolbase/draw_ms_priors.ddRAD_Dianthus.2pop.2018-08-29.py -bpfile $bpfile -argfile $argfile | $toolbase/msnsam/msnsam tbs $msnsam_arg2 $msnsam_model_cmd | python $toolbase/ms2stats.arbitrary_npop.counter.record_coaltime.py | python $toolbase/ms2stats.arbitrary_npop.stats.py
