...
print "retained genes:	", len(genes_lengths_4xdegens.keys())
export_genes_lengths_4xdegens(genes_lengths_4xdegens)

filter_and_modify_vcf (args.vcf, positions_of_4xdegen, regions_to_retain, genelists_per_chrom)

# filter the VCF for 4xdegen positions and modify the CHROM column
