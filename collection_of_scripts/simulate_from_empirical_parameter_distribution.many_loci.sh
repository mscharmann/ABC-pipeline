...
LSB_JOBINDEX=1
ori_dir=..
bpfile=Dianthus.sylvestris_vs_threespecies.minpres0.8.2018-02-12.vcf.recode.vcf.genepop.txt.bpfile.txt
spinput=Dianthus.sylvestris_vs_threespecies.minpres0.8.2018-02-12.vcf.recode.vcf.genepop.txt.spinput.txt
empdistrfile=param_estim_results.253k.Dianthus_exponential_growth.posterior_distributions.txt
