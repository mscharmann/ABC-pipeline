...
scenario=twophase_mig_interval
...
python $toolbase/draw_ms_priors.2017-11-15.py -bpfile $bpfile -argfile $argfile  | $toolbase/msnsam/msnsam tbs $msnsam_arg2 $msnsam_model_cmd | python $toolbase/ms2stats.counter.py | python $toolbase/ms2stats.2pop.stats.11apr16.py
