...
python $toolbase/draw_ms_priors.3pop.py -bpfile $bpfile -argfile $argfile  | $toolbase/msnsam/msnsam tbs $msnsam_arg2 $msnsam_model_cmd_mig23 | python $toolbase/ms2stats.3pop.counter.py | python $toolbase/ms2stats.3pop.stats.2DSFS.v2.py
