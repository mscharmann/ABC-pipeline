...
# the pipeline itself
python $toolbase/draw_ms_priors_from_empirical_distribution.ddRAD_Dianthus.single_pop.2018-08-31.py -bpfile $bpfile -argfile $argfile -emp_distr $empdrfile | $toolbase/msnsam/msnsam tbs $msnsam_arg2 $msnsam_model_cmd | python $toolbase/ms2stats.arbitrary_npop.counter.record_coaltime.py | python $toolbase/ms2stats.arbitrary_npop.stats.py
